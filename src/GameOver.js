...
const State = props => {
  ...
  const players = Object.keys(game.player_state)
    .map((playerID, index) => {
  ...
  const ordered = [...players].sort((a, b) => a.duration < b.duration ? -1 : 1)
